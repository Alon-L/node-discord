...
class BotAPI {
    ...
    fetchChannel(channelId) {
        return __awaiter(this, void 0, void 0, function* () {
            const channel = yield this.requests.send(endpoints_1.EndpointRoute.Channel, { channelId }, constants_1.HttpMethod.Get);
     ...
     */
    fetchGuildChannel(channelId) {
        return __awaiter(this, void 0, void 0, function* () {
            const channel = yield this.fetchChannel(channelId);
            return utils_1.ChannelUtils.createGuildChannel(this.bot, channel.structure, yield utils_1.ChannelUtils.getChannelGuild(this.bot, channel));
        });
    }
    /**
     ...
     * @returns {Promise<GuildChannel>}
     */
    modifyGuildChannel(channelId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const channelData = yield this.requests.send(endpoints_1.EndpointRoute.Channel, { channelId }, constants_1.HttpMethod.Patch, APISerializer_1.APISerializer.guildChannelOptions(options));
            return utils_1.ChannelUtils.createGuildChannel(this.bot, channelData, yield utils_1.ChannelUtils.getChannelGuild(this.bot, channelData));
        });
    }
    /**
    ...
    deleteChannel(channelId) {
        return __awaiter(this, void 0, void 0, function* () {
            const channelData = yield this.requests.send(endpoints_1.EndpointRoute.Channel, { channelId }, constants_1.HttpMethod.Delete);
    ...
    deleteGuildChannel(channelId) {
        return __awaiter(this, void 0, void 0, function* () {
            const channel = yield this.deleteChannel(channelId);
     ...
     */
    fetchSomeMessages(channelId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const messages = (yield this.requests.send(endpoints_1.EndpointRoute.ChannelMessages, { channelId }, constants_1.HttpMethod.Get, APISerializer_1.APISerializer.fetchSomeMessagesOptions(options)));
    ...
    fetchMessage(channelId, messageId) {
        return __awaiter(this, void 0, void 0, function* () {
            const message = yield this.requests.send(endpoints_1.EndpointRoute.ChannelMessage, { channelId, messageId }, constants_1.HttpMethod.Get);
            const channel = yield this.bot.channels.getText(channelId);
    ...
    sendMessage(channelId, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof data === 'string') {
                ...
                params = yield APISerializer_1.APISerializer.messageData(data);
                files = data.files;
            }
            const messageData = yield this.requests.send(endpoints_1.EndpointRoute.ChannelMessages, { channelId }, constants_1.HttpMethod.Post, params, files);
            const channel = yield this.bot.channels.getText(channelId);
    ...
    addMessageReaction(channelId, messageId, emoji) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.requests.send(endpoints_1.EndpointRoute.ChannelMessagesReactionsEmojiUser, { channelId, messageId, emoji: encodeURI(identifier) }, constants_1.HttpMethod.Put);
        });
    }
    /**
     ...
     * @returns {Promise<void>}
     */
    removeMessageReaction(channelId, messageId, emoji, userId = '@me') {
        return __awaiter(this, void 0, void 0, function* () {
            const identifier = structures_1.Emoji.resolve(this.bot.emojis, emoji);
            if (!identifier) {
            ...
            yield this.requests.send(endpoints_1.EndpointRoute.ChannelMessagesReactionsEmojiUser, {
                channelId,
                messageId,
     ...
     */
    fetchReactionUsers(channelId, messageId, emoji, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const users = (yield this.requests.send(endpoints_1.EndpointRoute.ChannelMessagesReactionsEmoji, {
                channelId,
                messageId,
                emoji,
    ...
    removeMessageReactions(channelId, messageId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.requests.send(endpoints_1.EndpointRoute.ChannelMessagesReactions, {
                channelId,
                messageId,
            }, constants_1.HttpMethod.Delete);
        });
     ...
     * @returns {Promise<void>}
     */
    removeMessageReactionsEmoji(channelId, messageId, emoji) {
        return __awaiter(this, void 0, void 0, function* () {
            const identifier = structures_1.Emoji.resolve(this.bot.emojis, emoji);
            if (!identifier) {
                throw new Error(`Invalid emoji for removeMessageReactionsEmoji request to channel (${channelId}) message (${messageId}) emoji (${emoji})`);
            }
            yield this.requests.send(endpoints_1.EndpointRoute.ChannelMessagesReactionsEmoji, {
                channelId,
                messageId,
                emoji: encodeURI(identifier),
            }, constants_1.HttpMethod.Delete);
    ...
    editMessage(channelId, messageId, data) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof data === 'string') {
                ...
                Object.assign(params, Object.assign(Object.assign({}, APISerializer_1.APISerializer.messageData(data)), { flags: (_a = data.flags) === null || _a === void 0 ? void 0 : _a.bits }));
            }
            const messageData = yield this.requests.send(endpoints_1.EndpointRoute.ChannelMessage, { channelId, messageId }, constants_1.HttpMethod.Patch, params);
            const channel = yield this.bot.channels.getText(channelId);
            return new message_1.Message(this.bot, messageData, channel);
        });
    }
    ...
    deleteMessage(channelId, messageId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.requests.send(endpoints_1.EndpointRoute.ChannelMessage, { channelId, messageId }, constants_1.HttpMethod.Delete);
        });
    }
    /**
    ...
    bulkDeleteMessages(channelId, messages) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.requests.send(endpoints_1.EndpointRoute.ChannelMessagesBulkDelete, { channelId }, constants_1.HttpMethod.Post, {
                messages,
            });
        });
    }
     ...
     * @returns {Promise<void>}
     */
    modifyGuildChannelPermissions(channelId, permissible, flags) {
        return __awaiter(this, void 0, void 0, function* () {
            const params = APISerializer_1.APISerializer.guildChannelPermissions(permissible, flags);
            yield this.requests.send(endpoints_1.EndpointRoute.ChannelPermissionsOverwrite, { channelId, overwriteId: permissible.id }, constants_1.HttpMethod.Put, params);
            const channel = yield this.bot.channels.getGuildChannel(channelId);
            return new structures_1.PermissionOverwrite(this.bot, Object.assign(Object.assign({}, params), { id: permissible.id }), channel);
        });
    }
    /**
    ...
    fetchChannelInvites(channelId) {
        return __awaiter(this, void 0, void 0, function* () {
            const invites = (yield this.requests.send(endpoints_1.EndpointRoute.ChannelInvites, { channelId }, constants_1.HttpMethod.Get));
    ...
    createChannelInvite(channelId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const invite = yield this.requests.send(endpoints_1.EndpointRoute.ChannelInvites, { channelId }, constants_1.HttpMethod.Post, APISerializer_1.APISerializer.inviteOptions(options));
     ...
     * @returns {Promise<void>}
     */
    deleteGuildChannelPermission(channelId, permissible) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.requests.send(endpoints_1.EndpointRoute.ChannelPermissionsOverwrite, { channelId, overwriteId: permissible }, constants_1.HttpMethod.Delete);
        });
    }
    /**
     ...
     * @returns {Promise<void>}
     */
    triggerTextChannelTyping(channelId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.requests.send(endpoints_1.EndpointRoute.ChannelTyping, { channelId }, constants_1.HttpMethod.Post);
        });
    }
    /**
    ...
    fetchChannelPins(channelId) {
        return __awaiter(this, void 0, void 0, function* () {
            const pins = (yield this.requests.send(endpoints_1.EndpointRoute.ChannelPins, { channelId }, constants_1.HttpMethod.Get));
            const channel = yield this.bot.channels.getText(channelId);
    ...
    pinMessage(channelId, messageId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.requests.send(endpoints_1.EndpointRoute.ChannelPinsMessage, { channelId, messageId }, constants_1.HttpMethod.Put);
        });
    }
    /**
    ...
    unpinMessage(channelId, messageId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.requests.send(endpoints_1.EndpointRoute.ChannelPinsMessage, { channelId, messageId }, constants_1.HttpMethod.Delete);
        });
    }
    /**
    ...
    fetchGuildEmojis(guildId) {
        return __awaiter(this, void 0, void 0, function* () {
            const emojis = (yield this.requests.send(endpoints_1.EndpointRoute.GuildEmojis, { guildId }, constants_1.HttpMethod.Get));
            const guild = yield this.bot.guilds.get(guildId);
    ...
    fetchGuildEmoji(guildId, emojiId) {
        return __awaiter(this, void 0, void 0, function* () {
            const emoji = yield this.requests.send(endpoints_1.EndpointRoute.GuildEmoji, { guildId, emojiId }, constants_1.HttpMethod.Get);
            const guild = yield this.bot.guilds.get(guildId);
    ...
    createGuildEmoji(guildId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const emoji = yield this.requests.send(endpoints_1.EndpointRoute.GuildEmojis, { guildId }, constants_1.HttpMethod.Post, yield APISerializer_1.APISerializer.createEmojiOptions(options));
            const guild = yield this.bot.guilds.get(guildId);
            return new guild_1.GuildEmoji(this.bot, emoji, guild);
        });
    }
     ...
     */
    modifyGuildEmoji(guildId, emojiId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const emoji = yield this.requests.send(endpoints_1.EndpointRoute.GuildEmoji, { guildId, emojiId }, constants_1.HttpMethod.Patch, APISerializer_1.APISerializer.modifyEmojiOptions(options));
            const guild = yield this.bot.guilds.get(guildId);
            return new guild_1.GuildEmoji(this.bot, emoji, guild);
        });
    }
    ...
    deleteGuildEmoji(guildId, emojiId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.requests.send(endpoints_1.EndpointRoute.GuildEmoji, { guildId, emojiId }, constants_1.HttpMethod.Delete);
        });
    }
    /**
    ...
    fetchGuild(guildId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const guild = yield this.requests.send(endpoints_1.EndpointRoute.Guild, { guildId }, constants_1.HttpMethod.Get, APISerializer_1.APISerializer.fetchGuildOptions(options));
    ...
    fetchGuildPreview(guildId) {
        return __awaiter(this, void 0, void 0, function* () {
            const preview = yield this.requests.send(endpoints_1.EndpointRoute.GuildPreview, { guildId }, constants_1.HttpMethod.Get);
     ...
     * @returns {Promise<Guild>}
     */
    modifyGuild(guildId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const guild = yield this.requests.send(endpoints_1.EndpointRoute.Guild, { guildId }, constants_1.HttpMethod.Patch, yield APISerializer_1.APISerializer.modifyGuildOptions(options));
            return new guild_1.Guild(this.bot, guild);
        });
    }
    /**
    ...
    fetchGuildChannels(guildId) {
        return __awaiter(this, void 0, void 0, function* () {
            const channels = (yield this.requests.send(endpoints_1.EndpointRoute.GuildChannels, { guildId }, constants_1.HttpMethod.Get));
            const guild = yield this.bot.guilds.get(guildId);
    ...
    createGuildChannel(guildId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const channel = yield this.requests.send(endpoints_1.EndpointRoute.GuildChannels, { guildId }, constants_1.HttpMethod.Post, APISerializer_1.APISerializer.createGuildChannelOptions(options));
            const guild = yield this.bot.guilds.get(guildId);
     ...
     * @returns {Promise<void>}
     */
    modifyGuildChannelsPositions(guildId, positions) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.requests.send(endpoints_1.EndpointRoute.GuildChannels, { guildId }, constants_1.HttpMethod.Patch, APISerializer_1.APISerializer.positions(positions));
        });
    }
    /**
    ...
    fetchMember(guildId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const member = yield this.requests.send(endpoints_1.EndpointRoute.GuildMember, { guildId, userId }, constants_1.HttpMethod.Get);
            const guild = yield this.bot.guilds.get(guildId);
     ...
     */
    fetchSomeMembers(guildId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const members = (yield this.requests.send(endpoints_1.EndpointRoute.GuildMembers, { guildId }, constants_1.HttpMethod.Get, APISerializer_1.APISerializer.fetchSomeMembersOptions(options)));
            const guild = yield this.bot.guilds.get(guildId);
     ...
     * @returns {Promise<void>}
     */
    modifyMember(guildId, userId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.requests.send(endpoints_1.EndpointRoute.GuildMember, { guildId, userId }, constants_1.HttpMethod.Patch, APISerializer_1.APISerializer.modifyMemberOptions(options));
        });
    }
    /**
     ...
     */
    modifyBotNickname(guildId, nick) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.requests.send(endpoints_1.EndpointRoute.GuildMemberBotNick, { guildId }, constants_1.HttpMethod.Patch, {
                nick,
            });
        });
    }
     ...
     * @returns {Promise<void>}
     */
    memberAddRole(guildId, userId, roleId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.requests.send(endpoints_1.EndpointRoute.GuildMemberRole, { guildId, userId, roleId }, constants_1.HttpMethod.Put);
        });
    }
    /**
     ...
     * @returns {Promise<void>}
     */
    memberRemoveRole(guildId, userId, roleId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.requests.send(endpoints_1.EndpointRoute.GuildMemberRole, { guildId, userId, roleId }, constants_1.HttpMethod.Delete);
        });
    }
    /**
    ...
    removeMember(guildId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.requests.send(endpoints_1.EndpointRoute.GuildMember, { guildId, userId }, constants_1.HttpMethod.Delete);
        });
    }
    /**
    ...
    fetchGuildBans(guildId) {
        return __awaiter(this, void 0, void 0, function* () {
            const bans = yield this.requests.send(endpoints_1.EndpointRoute.GuildBans, { guildId }, constants_1.HttpMethod.Get);
            const guild = yield this.bot.guilds.get(guildId);
    ...
    fetchGuildBan(guildId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const ban = yield this.requests.send(endpoints_1.EndpointRoute.GuildBan, { guildId, userId }, constants_1.HttpMethod.Get);
            const guild = yield this.bot.guilds.get(guildId);
    ...
    banMember(guildId, userId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.requests.send(endpoints_1.EndpointRoute.GuildBan, { guildId, userId }, constants_1.HttpMethod.Put, APISerializer_1.APISerializer.banMemberOptions(options));
        });
    }
    /**
    ...
    unbanMember(guildId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.requests.send(endpoints_1.EndpointRoute.GuildBan, { guildId, userId }, constants_1.HttpMethod.Delete);
        });
    }
    /**
    ...
    fetchRoles(guildId) {
        return __awaiter(this, void 0, void 0, function* () {
            const roles = yield this.requests.send(endpoints_1.EndpointRoute.GuildRoles, { guildId }, constants_1.HttpMethod.Get);
            const guild = yield this.bot.guilds.get(guildId);
    ...
    createRole(guildId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const role = yield this.requests.send(endpoints_1.EndpointRoute.GuildRoles, { guildId }, constants_1.HttpMethod.Post, APISerializer_1.APISerializer.roleOptions(options));
            const guild = yield this.bot.guilds.get(guildId);
     ...
     */
    modifyRolesPositions(guildId, positions) {
        return __awaiter(this, void 0, void 0, function* () {
            const roles = yield this.requests.send(endpoints_1.EndpointRoute.GuildRoles, { guildId }, constants_1.HttpMethod.Patch, APISerializer_1.APISerializer.positions(positions));
            const guild = yield this.bot.guilds.get(guildId);
            return new Collection_1.default(roles.map(role => [role.id, new structures_1.Role(this.bot, role, guild)]));
        });
    }
    ...
    modifyRole(guildId, roleId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const role = yield this.requests.send(endpoints_1.EndpointRoute.GuildRole, { guildId, roleId }, constants_1.HttpMethod.Patch, APISerializer_1.APISerializer.roleOptions(options));
            const guild = yield this.bot.guilds.get(guildId);
            return new structures_1.Role(this.bot, role, guild);
        });
    }
    ...
    deleteRole(guildId, roleId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.requests.send(endpoints_1.EndpointRoute.GuildRole, { guildId, roleId }, constants_1.HttpMethod.Delete);
        });
    }
    /**
     ...
     */
    guildPruneCount(guildId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const { pruned } = yield this.requests.send(endpoints_1.EndpointRoute.GuildPrune, { guildId }, constants_1.HttpMethod.Get, APISerializer_1.APISerializer.pruneCountOptions(options));
            return pruned;
        });
    }
    /**
     ...
     */
    guildPrune(guildId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const { pruned } = yield this.requests.send(endpoints_1.EndpointRoute.GuildPrune, { guildId }, constants_1.HttpMethod.Post, APISerializer_1.APISerializer.pruneOptions(options));
            return pruned;
        });
    }
    /**
    ...
    fetchGuildInvites(guildId) {
        return __awaiter(this, void 0, void 0, function* () {
            const invites = yield this.requests.send(endpoints_1.EndpointRoute.GuildInvites, { guildId }, constants_1.HttpMethod.Get);
            const guild = yield this.bot.guilds.get(guildId);
    ...
    fetchGuildIntegrations(guildId) {
        return __awaiter(this, void 0, void 0, function* () {
            const integrations = yield this.requests.send(endpoints_1.EndpointRoute.GuildIntegrations, { guildId }, constants_1.HttpMethod.Get);
            const guild = yield this.bot.guilds.get(guildId);
    ...
    createGuildIntegration(guildId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.requests.send(endpoints_1.EndpointRoute.GuildIntegration, { guildId }, constants_1.HttpMethod.Post, APISerializer_1.APISerializer.createIntegrationOptions(options));
        });
    }
    /**
     ...
     * @returns {Promise<void>}
     */
    modifyGuildIntegration(guildId, integrationId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.requests.send(endpoints_1.EndpointRoute.GuildIntegration, { guildId, integrationId }, constants_1.HttpMethod.Patch, APISerializer_1.APISerializer.modifyIntegrationOptions(options));
        });
    }
    /**
    ...
    deleteGuildIntegration(guildId, integrationId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.requests.send(endpoints_1.EndpointRoute.GuildIntegration, { guildId, integrationId }, constants_1.HttpMethod.Delete);
        });
    }
    /**
    ...
    syncGuildIntegration(guildId, integrationId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.requests.send(endpoints_1.EndpointRoute.GuildIntegrationSync, { guildId, integrationId }, constants_1.HttpMethod.Post);
        });
    }
    /**
    ...
    fetchGuildWidget(guildId) {
        return __awaiter(this, void 0, void 0, function* () {
            const widget = yield this.requests.send(endpoints_1.EndpointRoute.GuildWidget, { guildId }, constants_1.HttpMethod.Get);
            const guild = yield this.bot.guilds.get(guildId);
    ...
    modifyGuildWidget(guildId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const widget = yield this.requests.send(endpoints_1.EndpointRoute.GuildWidget, { guildId }, constants_1.HttpMethod.Patch, APISerializer_1.APISerializer.modifyWidgetOptions(options));
            const guild = yield this.bot.guilds.get(guildId);
            return new guild_2.GuildWidget(this.bot, widget, guild);
        });
    }
    ...
    fetchGuildVanityURL(guildId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.requests.send(endpoints_1.EndpointRoute.GuildVanityURL, { guildId }, constants_1.HttpMethod.Get);
        });
    }
    /**
    ...
    fetchBotUser() {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield this.requests.send(endpoints_1.EndpointRoute.UserBot, {}, constants_1.HttpMethod.Get);
    ...
    fetchUser(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield this.requests.send(endpoints_1.EndpointRoute.User, { userId }, constants_1.HttpMethod.Get);
     ...
     * @returns {Promise<BotUser>}
     */
    modifyBotUser(options) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield this.requests.send(endpoints_1.EndpointRoute.UserBot, {}, constants_1.HttpMethod.Patch, yield APISerializer_1.APISerializer.modifyBotUserOptions(options));
            return new structures_1.BotUser(this.bot, user);
        });
    }
    /**
     ...
     */
    fetchBotGuilds(options) {
        return __awaiter(this, void 0, void 0, function* () {
            const guilds = yield this.requests.send(endpoints_1.EndpointRoute.UserBotGuilds, {}, constants_1.HttpMethod.Get, APISerializer_1.APISerializer.fetchGuildsOptions(options));
    ...
    leaveGuild(guildId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.requests.send(endpoints_1.EndpointRoute.UserBotGuild, { guildId }, constants_1.HttpMethod.Delete);
        });
    }
    /**
    ...
    createDM(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const dmChannel = yield this.requests.send(endpoints_1.EndpointRoute.UserBotChannels, {}, constants_1.HttpMethod.Post, APISerializer_1.APISerializer.createDM(userId));
     ...
     * @returns {Promise<Invite>}
     */
    fetchInvite(inviteCode, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const invite = yield this.requests.send(endpoints_1.EndpointRoute.Invite, { inviteCode }, constants_1.HttpMethod.Get, APISerializer_1.APISerializer.fetchInviteOptions(options));
            return new structures_1.Invite(this.bot, invite);
        });
    }
    /**
    ...
    deleteInvite(inviteCode) {
        return __awaiter(this, void 0, void 0, function* () {
            const invite = yield this.requests.send(endpoints_1.EndpointRoute.Invite, { inviteCode }, constants_1.HttpMethod.Delete);
            return new structures_1.Invite(this.bot, invite);
        });
    }
    /**
    ...
    createWebhook(channelId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const webhook = yield this.requests.send(endpoints_1.EndpointRoute.ChannelWebhooks, { channelId }, constants_1.HttpMethod.Post, yield APISerializer_1.APISerializer.createWebhookOptions(options));
            const channel = yield this.bot.channels.getGuildChannel(channelId);
    ...
    fetchWebhooks(channelId) {
        return __awaiter(this, void 0, void 0, function* () {
            const webhooks = yield this.requests.send(endpoints_1.EndpointRoute.ChannelWebhooks, { channelId }, constants_1.HttpMethod.Get);
            const channel = yield this.bot.channels.getGuildChannel(channelId);
    ...
    fetchGuildWebhooks(guildId) {
        return __awaiter(this, void 0, void 0, function* () {
            const webhooks = yield this.requests.send(endpoints_1.EndpointRoute.GuildWebhooks, { guildId }, constants_1.HttpMethod.Get);
            return new Collection_1.default(yield Promise.all(webhooks.map((webhook) => __awaiter(this, void 0, void 0, function* () {
    ...
    fetchWebhook(webhookId) {
        return __awaiter(this, void 0, void 0, function* () {
            const webhook = yield this.requests.send(endpoints_1.EndpointRoute.Webhook, { webhookId }, constants_1.HttpMethod.Get);
            const { channel_id: channelId } = webhook;
            const channel = yield this.bot.channels.getGuildChannel(channelId);
            return new structures_1.Webhook(this.bot, webhook, channel);
        });
     ...
     * @returns {Promise<Webhook>}
     */
    modifyWebhook(webhookId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const webhook = yield this.requests.send(endpoints_1.EndpointRoute.Webhook, { webhookId }, constants_1.HttpMethod.Patch, yield APISerializer_1.APISerializer.modifyWebhookOptions(options));
            const { channel_id: channelId } = webhook;
            const channel = yield this.bot.channels.getGuildChannel(channelId);
            return new structures_1.Webhook(this.bot, webhook, channel);
        });
    ...
    deleteWebhook(webhookId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.requests.send(endpoints_1.EndpointRoute.Webhook, { webhookId }, constants_1.HttpMethod.Delete);
        });
    }
}
