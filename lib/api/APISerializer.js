...
class APISerializer {
     ...
     */
    static async createEmojiOptions(options) {
        return {
            name: options.name,
     ...
     * @returns {Promise<Params>}
     */
    static async modifyGuildOptions(options) {
     ...
     * @returns {Promise<Params>}
     */
    static async modifyBotUserOptions(options) {
        return {
     ...
     * @returns {Promise<Params>}
     */
    static async createWebhookOptions(options) {
        return {
            name: options.name,
            avatar: options.avatar && (await options.avatar.stringify()),
        };
     ...
     * @returns {Promise<Params>}
     */
    static async modifyWebhookOptions(options) {
        return {
            name: options.name,
            avatar: options.avatar && (await options.avatar.stringify()),
            channel_id: options.channelId,
