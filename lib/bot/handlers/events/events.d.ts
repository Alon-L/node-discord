...
import { Emoji, Invite, PartialInvite, Role, Timestamp, User, TextBasedChannel } from '../../../structures';
 ...
 */
declare function CHANNEL_PINS_UPDATE(channel: TextBasedChannel, oldPinTimestamp: Timestamp | undefined): any;
/**
 ...
 */
declare function GUILD_UPDATE(before: Guild | GuildUnavailable, after: Guild | GuildUnavailable): any;
/**
 ...
 */
declare function GUILD_EMOJIS_UPDATE(before: Collection<Snowflake, Emoji>, after: Collection<Snowflake, Emoji>): any;
/**
 ...
 */
declare function GUILD_MEMBERS_CHUNK(guild: Guild, nonce: string | undefined, chunk: GuildMembersChunk): any;
/**
 ...
 */
declare function MESSAGE_DELETE_BULK(channel: TextBasedChannel, messages: (Message | Snowflake)[]): any;
/**
 ...
 */
declare function MESSAGE_REACTION_ADD(reaction: MessageReaction, user: Member | User | undefined): any;
/**
 ...
 */
declare function MESSAGE_REACTION_REMOVE(reaction: MessageReaction, user: Member | User | undefined): any;
/**
 ...
 */
declare function TYPING_START(channel: TextBasedChannel | undefined, user: Member | User | undefined, startedAt: number): any;
/**
 ...
 */
declare function VOICE_SERVER_UPDATE(guild: Guild, voiceServer: {
    token: string;
    endpoint: string;
}): any;
/**
 ...
 */
export declare type BotStateEvents = BotEvent.Ready | BotEvent.Close;
/**
