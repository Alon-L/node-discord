...
const GuildVoice_1 = __importDefault(require("../voice/GuildVoice"));
const VoiceState_1 = __importDefault(require("../voice/VoiceState"));
/**
...
class Guild extends GuildPreview_1.GuildPreview {
    ...
    init(guild) {
        ...
        this.voice = new GuildVoice_1.default(this);
        ...
        if (guild.voice_states) {
            for (const voicestate of guild.voice_states) {
                this.voiceStates.set(voicestate.user_id, new VoiceState_1.default(this.bot, this.members.cache.get(voicestate.user_id), voicestate));
            }
        }
