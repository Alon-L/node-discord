...
class BotSocket {
     ...
     */
    startShards(timeout = constants_1.recommendedShardTimeout) {
        return __awaiter(this, void 0, void 0, function* () {
            const { url: gatewayURL, shards: suggestedShards, session_start_limit: sessionStartLimit, } = yield this.gateway;
