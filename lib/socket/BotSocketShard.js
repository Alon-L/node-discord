...
class BotSocketShard {
    ...
    configure() {
        ...
        this.options = Object.assign({ v: api_1.version, encoding: erlpack ? 'etf' : 'json', compress: zlib && 'zlib-stream' }, this.bot.options.websocket);
    ...
    connect(resume = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.handleSessionLimit(sessionStartLimit);
    ...
    identify() {
        ...
        this.send({
            op: 2 /* Identify */,
            d: Object.assign(Object.assign({}, properties_1.identify), { token: this.token, shard: [id, amount] }),
        });
    }
    /**
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!constants_1.UnreconnectableGatewayCloseCodes.includes(code)) {
                if (this.retryTimeout) {
                    yield new Promise(resolve => setTimeout(resolve, this.retryTimeout));
                }
                this.retryTimeout += 1000;
                yield this.connect(!constants_1.UnresumeableGatewayCloseCodes.includes(code));
            }
        });
    }
    /**
     ...
     * @returns {Promise<void>}
     */
    handleSessionLimit(sessionLimit) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (remaining === 0) {
                ...
                yield new Promise(resolve => setTimeout(resolve, resetAfter));
            }
        });
    }
    /**
